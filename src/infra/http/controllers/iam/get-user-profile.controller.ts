...
import { BadRequestException, Controller, Get, HttpCode, Inject, NotFoundException, Request, UseGuards } from "@nestjs/common";
...
export class GetUserProfileController {
  ...
  async handle(@CurrentUser() userPayload: UserPayload,) {    
    const result = await this.getUserProfile.execute({userId: userPayload.sub});
