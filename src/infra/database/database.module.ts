...
import { PrismaCaseAnalysisRepository } from "./prisma/repositories/prisma-case-analysis-repository";
...
@Module({
  providers: [
    ...
    {
      provide: CaseAnalysisRepository,
      useClass: PrismaCaseAnalysisRepository,
    },
  ],
  exports: [
    PrismaService,
